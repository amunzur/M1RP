...
called = pd.read_csv('C:/Users/amurtha/Dropbox/Ghent M1 2019/sandbox/mutations/final melted mutations/M1RP_mutations.tsv', sep = '\t')
...
muts = muts.sort_values(['Sample ID','Lr_flag','Allosome_flag','Depth_flag','Non-truncal flag', 'gDNA_flag','mut_TC'], ascending = [True,False,False,False,False,False,False])

muts = muts[['Cohort', 'Patient ID', 'Sample ID','mut_TC', 'CHROM', 'POSITION', 'REF', 'ALT','GENE', 'EFFECT', 'Allele_frequency', 'Read_depth', 'NOTES', 'Log_ratio', 'Allosome_flag','Depth_flag','Lr_flag','Non-truncal flag','gDNA_flag']]
...
muts.to_excel('C:/Users/amurtha/Dropbox/Ghent M1 2019/sandbox/tumor_fraction/%s_mut_tc_allMuts.xlsx' % cohort, index = None)
...
muts.to_csv('C:/Users/amurtha/Dropbox/Ghent M1 2019/sandbox/tumor_fraction/%s_mut_tc.tsv' % cohort, sep = '\t', index = None)