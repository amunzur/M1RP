...
ax.scatter(pos_tc['mut_TC'],pos_tc['snp_TC'], s = 10, c = 'k', alpha = 0.5)
ax.plot([0,1],[0,1])
...
plt.savefig('G:/Andy Murtha/Ghent/M1RP/dev/SNP_analysis/%s_mutsnpTC_scatter_truncalOnly' % cohort)
plt.savefig('G:/Andy Murtha/Ghent/M1RP/dev/SNP_analysis/%s_mutsnpTC_scatter_truncalOnly.png' % cohort, dpi = 500)
plt.savefig('C:/Users/amurtha/Dropbox/Ghent M1 2019/sandbox/SNPs/%s_mutsnpTC_scatter_truncalOnly.pdf' % cohort)