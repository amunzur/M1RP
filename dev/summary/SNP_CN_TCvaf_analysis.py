...
unsequenced = pd.read_excel('C:/Users/amurtha/Downloads/GSC samples submission - February 2021 - M1RP only.xlsx')
...
samples = samples[~samples['Patient ID'].isin(['ID38','ID29','ID40','ID41','ID39'])]
samples = samples[~samples['Sample ID'].isin(unsequenced['Sample ID'].tolist())]
