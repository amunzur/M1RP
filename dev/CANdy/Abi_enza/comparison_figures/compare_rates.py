...
mat = nas.groupby(['GENE','Copy_num']).count().reset_index()[['GENE','Copy_num','START']]
...
fig.savefig('G:/Andy Murtha/Ghent/M1RP/dev/CANdy/Abi_enza/comparison_figures/rates_comparison%sTC.pdf' % limit_tf)