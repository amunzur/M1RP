# -*- coding: utf-8 -*-
"""
Created on Mon Jun 28 17:48:46 2021
...
ax.scatter(sim['TC_diff'], sim['JSI'], s = 4, lw = 0, c = 'k', zorder = 100)

ax.set_ylabel('JSI')
ax.set_xlabel('TC difference between samples')

xlim = ax.get_xlim()
ylim = ax.get_ylim()

lin = stats.linregress(sim['TC_diff'],sim['JSI'])
...
fig.tight_layout()
fig.savefig('C:/Users/amurtha/Dropbox/Ghent M1 2019/Figures/summary/TCdiff_JSI_scatter.pdf')
fig.savefig('C:/Users/amurtha/Dropbox/Ghent M1 2019/Figures/summary/TCdiff_JSI_scatter.png')