# -*- coding: utf-8 -*-
"""
Created on Wed May 19 13:43:53 2021
...
color = 'pink'
defective_patient_number = str(len(lat_1))
defective_label = str(str('Lat. 1 ')+r"(n="+defective_patient_number+")")
T = lat_1['Time_to_CRPC'].round(3)
C = lat_1['crpc_status'].astype(np.int32)
kmf2.fit(T, event_observed = C, label = defective_label)
kmf2.plot(ax=ax,show_censors = True, ci_show = False, color = color, lw = 1)
# lat_1_median=kmf2.median
...
defective_label = str(str('Lat. 2-3 ')+r"(n="+defective_patient_number+")")
...
plt.savefig('C:/Users/amurtha/Dropbox/Ghent M1 2019/Figures/Work from 2021/summary/KM_byLatCriteria.pdf')