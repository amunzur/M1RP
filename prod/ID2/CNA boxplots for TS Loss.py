# -*- coding: utf-8 -*-
"""
Created on Tue Apr 27 16:57:43 2021
...
color_dict = {'Intronic':'grey', "3'-UTR":'grey'}
...
order = {
 ...
 'M1RP_ID2_MLN6':1,
 'M1RP_ID2_MLN7':2,
 'M1RP_ID2_cfDNA_2017Apr26':2,
 'M1RP_ID2_cfDNA_2018Mar22':3,
 'M1RP_ID2_cfDNA_2018Jun07':4,
 'M1RP_ID2_cfDNA_2016Oct05':1}
...
tc = tc[tc['Patient ID'] == 'ID2']
cn = cn[cn['Patient ID'] == 'ID2']
...
muts['GENE'] = muts['GENE'].replace({'BIVM-ERCC5;ERCC5':'ERCC5'})
...
for gene in goi:
    ...
    ax1.plot([-1,5],[2,2],lw = 0.5, ls = 'dashed', color = 'grey')
    ax2.plot([-1,8],[2,2],lw = 0.5, ls = 'dashed', color = 'grey')
    ax3.plot([-1,8],[2,2],lw = 0.5, ls = 'dashed', color = 'grey')
    
    ax1.plot([-1,5],[1,1],lw = 0.5, ls = 'dashed', color = 'blue')
    ax2.plot([-1,8],[1,1],lw = 0.5, ls = 'dashed', color = 'blue')
    ax3.plot([-1,8],[1,1],lw = 0.5, ls = 'dashed', color = 'blue')
...
fig.savefig('C:/Users/amurtha/Dropbox/Ghent M1 2019/Figures/Work from 2021/ID2/ID2_TStracking.pdf')