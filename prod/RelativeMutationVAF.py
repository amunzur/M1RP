...
color_dict = {'TP53':'blue','RNF43':'orange','PTEN':'green'}
...
muts['Color'] = muts['GENE'].map(color_dict)
...
muts = muts.sort_values(['Count','Final tNGS_TC'], ascending = [True, False])
...
fig.legend([Line2D([0],[0], marker = 'o', lw = 0, markeredgewidth=0, markerfacecolor=x, markersize = 4) for x in list(color_dict.values())], [x for x in list(color_dict.keys())], fontsize = 6)
...
fig.savefig('C:/Users/amurtha/Dropbox/Ghent M1 2019/Figures/Work from 2021/ID33/relative VAF.pdf', transparent=True)